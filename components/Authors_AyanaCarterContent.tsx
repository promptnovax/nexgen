...
export default function Authors_AyanaCarterContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/authors/ayana-carter */}
