...
export default function BlogCategories_MusicContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/blog-categories/music */}
