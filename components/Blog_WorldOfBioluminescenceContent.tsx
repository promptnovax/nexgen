...
export default function Blog_WorldOfBioluminescenceContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/blog/world-of-bioluminescence */}
