...
export default function Blog_ATransformativeJourneyContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/blog/a-transformative-journey */}
