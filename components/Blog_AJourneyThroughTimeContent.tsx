...
export default function Blog_AJourneyThroughTimeContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/blog/a-journey-through-time */}
