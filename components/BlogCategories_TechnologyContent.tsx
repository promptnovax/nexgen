...
export default function BlogCategories_TechnologyContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/blog-categories/technology */}
