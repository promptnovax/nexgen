...
export default function TermsConditionsContent() {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/terms-conditions */}
