...
export default function Authors_EmilyDavisContent() {
  useEffect(() => {
  ...
  return (
    <div className="webflow-page-wrapper">
      {/* Generated from https://nexgen-blog.webflow.io/authors/emily-davis */}
